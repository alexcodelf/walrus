...
func Create(
	...
	err := opts.ModelClient.WithTx(ctx, func(tx *model.Tx) (err error) {
	...
	ready, err := CheckDependencyStatus(ctx, opts.ModelClient, entity)
	if err != nil {
		return nil, err
	}
...
func Apply(
	...
	if err != nil {
		...
		err = UpdateStatus(ctx, opts.ModelClient, entity)
		if err != nil {
...
func Destroy(
	...
	// Check dependants.
	dependants, err := dao.GetServiceDependantNames(ctx, opts.ModelClient, entity)
	if err != nil {
	...
	if len(dependants) > 0 {
		...
		if !status.ServiceStatusProgressing.IsUnknown(entity) ||
			...
			if err = UpdateStatus(ctx, opts.ModelClient, entity); err != nil {
