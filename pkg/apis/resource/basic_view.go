...
func (r *DeleteRequest) Validate() error {
	...
	if !r.WithoutCleanup {
		if err = ValidateRunStatus(r.Context, r.Client, r.ID); err != nil {
			return err
		}
	}
...
func (r *PatchRequest) Validate() error {
	...
	if err = ValidateRunStatus(r.Context, r.Client, patched.ID); err != nil {
		return err
	}
...
func (r *CollectionDeleteRequest) Validate() error {
	...
	if r.WithoutCleanup {
		if err = ValidateRunStatus(r.Context, r.Client, ids...); err != nil {
			return err
		}
	}
...
// ValidateRunStatus validates run status of given resource IDs.
func ValidateRunStatus(ctx context.Context, mc model.ClientSet, ids ...object.ID) error {
