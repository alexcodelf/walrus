...
func init() {
	...
	serviceInters := schema.Service{}.Interceptors()
	service.Interceptors[0] = serviceInters[0]
	...
	serviceDescProjectID := serviceFields[0].Descriptor()
	...
	serviceDescEnvironmentID := serviceFields[1].Descriptor()
	...
	// serviceDescTemplateID is the schema descriptor for template_id field.
	serviceDescTemplateID := serviceFields[2].Descriptor()
	// service.TemplateIDValidator is a validator for the "template_id" field. It is called by the builders before save.
	service.TemplateIDValidator = serviceDescTemplateID.Validators[0].(func(string) error)
	...
	serviceresource.Interceptors[0] = serviceresourceInters[0]
	...
	serviceresourceDescProjectID := serviceresourceFields[0].Descriptor()
	...
	// serviceresourceDescEnvironmentID is the schema descriptor for environment_id field.
	serviceresourceDescEnvironmentID := serviceresourceFields[1].Descriptor()
	// serviceresource.EnvironmentIDValidator is a validator for the "environment_id" field. It is called by the builders before save.
	serviceresource.EnvironmentIDValidator = serviceresourceDescEnvironmentID.Validators[0].(func(string) error)
	// serviceresourceDescServiceID is the schema descriptor for service_id field.
	serviceresourceDescServiceID := serviceresourceFields[2].Descriptor()
	...
	serviceresourceDescConnectorID := serviceresourceFields[3].Descriptor()
	...
	serviceresourceDescMode := serviceresourceFields[6].Descriptor()
	...
	serviceresourceDescType := serviceresourceFields[7].Descriptor()
	...
	serviceresourceDescName := serviceresourceFields[8].Descriptor()
	...
	serviceresourceDescDeployerType := serviceresourceFields[9].Descriptor()
	...
	serviceresourceDescShape := serviceresourceFields[10].Descriptor()
	...
	// workflowDescDisplayName is the schema descriptor for display_name field.
	workflowDescDisplayName := workflowFields[2].Descriptor()
	// workflow.DisplayNameValidator is a validator for the "display_name" field. It is called by the builders before save.
	workflow.DisplayNameValidator = workflowDescDisplayName.Validators[0].(func(string) error)
	// workflowDescType is the schema descriptor for type field.
	workflowDescType := workflowFields[3].Descriptor()
	...
	// workflowDescWorkflowStageIds is the schema descriptor for workflow_stage_ids field.
	workflowDescWorkflowStageIds := workflowFields[4].Descriptor()
	// workflow.DefaultWorkflowStageIds holds the default value on creation for the workflow_stage_ids field.
	workflow.DefaultWorkflowStageIds = workflowDescWorkflowStageIds.Default.([]object.ID)
	// workflowDescParallelism is the schema descriptor for parallelism field.
	workflowDescParallelism := workflowFields[5].Descriptor()
	...
	// workflowexecutionDescProgress is the schema descriptor for progress field.
	workflowexecutionDescProgress := workflowexecutionFields[2].Descriptor()
	// workflowexecution.ProgressValidator is a validator for the "progress" field. It is called by the builders before save.
	workflowexecution.ProgressValidator = workflowexecutionDescProgress.Validators[0].(func(int) error)
	// workflowexecutionDescWorkflowStagesExecution is the schema descriptor for workflow_stages_execution field.
	workflowexecutionDescWorkflowStagesExecution := workflowexecutionFields[4].Descriptor()
	// workflowexecution.DefaultWorkflowStagesExecution holds the default value on creation for the workflow_stages_execution field.
	workflowexecution.DefaultWorkflowStagesExecution = workflowexecutionDescWorkflowStagesExecution.Default.([]object.ID)
	// workflowexecutionDescRecord is the schema descriptor for record field.
	workflowexecutionDescRecord := workflowexecutionFields[5].Descriptor()
	// workflowexecution.DefaultRecord holds the default value on creation for the record field.
	workflowexecution.DefaultRecord = workflowexecutionDescRecord.Default.(string)
	// workflowexecutionDescInput is the schema descriptor for input field.
	workflowexecutionDescInput := workflowexecutionFields[6].Descriptor()
	...
	// workflowstageDescDuration is the schema descriptor for duration field.
	workflowstageDescDuration := workflowstageFields[2].Descriptor()
	// workflowstage.DefaultDuration holds the default value on creation for the duration field.
	workflowstage.DefaultDuration = workflowstageDescDuration.Default.(int)
	// workflowstage.DurationValidator is a validator for the "duration" field. It is called by the builders before save.
	workflowstage.DurationValidator = workflowstageDescDuration.Validators[0].(func(int) error)
	// workflowstageDescDependencies is the schema descriptor for dependencies field.
	workflowstageDescDependencies := workflowstageFields[3].Descriptor()
	...
	workflowstageexecutionDescDuration := workflowstageexecutionFields[0].Descriptor()
	...
	// workflowstageexecutionDescStepExecutionIds is the schema descriptor for step_execution_ids field.
	workflowstageexecutionDescStepExecutionIds := workflowstageexecutionFields[3].Descriptor()
	// workflowstageexecution.DefaultStepExecutionIds holds the default value on creation for the step_execution_ids field.
	workflowstageexecution.DefaultStepExecutionIds = workflowstageexecutionDescStepExecutionIds.Default.([]object.ID)
	// workflowstageexecutionDescRecord is the schema descriptor for record field.
	workflowstageexecutionDescRecord := workflowstageexecutionFields[4].Descriptor()
	// workflowstageexecution.DefaultRecord holds the default value on creation for the record field.
	workflowstageexecution.DefaultRecord = workflowstageexecutionDescRecord.Default.(string)
	// workflowstageexecutionDescInput is the schema descriptor for input field.
	workflowstageexecutionDescInput := workflowstageexecutionFields[5].Descriptor()
	// workflowstageexecution.DefaultInput holds the default value on creation for the input field.
	workflowstageexecution.DefaultInput = workflowstageexecutionDescInput.Default.(string)
	...
	workflowstepDescDependencies := workflowstepFields[6].Descriptor()
	...
	workflowstepDescTimeout := workflowstepFields[8].Descriptor()
	...
	workflowstepexecutionDescType := workflowstepexecutionFields[4].Descriptor()
	...
	workflowstepexecutionDescTimes := workflowstepexecutionFields[6].Descriptor()
	...
	workflowstepexecutionDescDuration := workflowstepexecutionFields[7].Descriptor()
	...
	workflowstepexecutionDescRecord := workflowstepexecutionFields[8].Descriptor()
	...
	// workflowstepexecutionDescInput is the schema descriptor for input field.
	workflowstepexecutionDescInput := workflowstepexecutionFields[9].Descriptor()
	// workflowstepexecution.DefaultInput holds the default value on creation for the input field.
	workflowstepexecution.DefaultInput = workflowstepexecutionDescInput.Default.(string)
	workflowsteptemplateMixin := schema.WorkflowStepTemplate{}.Mixin()
	workflowsteptemplateMixinHooks0 := workflowsteptemplateMixin[0].Hooks()
	workflowsteptemplate.Hooks[0] = workflowsteptemplateMixinHooks0[0]
	workflowsteptemplateMixinFields0 := workflowsteptemplateMixin[0].Fields()
	_ = workflowsteptemplateMixinFields0
	workflowsteptemplateFields := schema.WorkflowStepTemplate{}.Fields()
	_ = workflowsteptemplateFields
	// workflowsteptemplateDescName is the schema descriptor for name field.
	workflowsteptemplateDescName := workflowsteptemplateMixinFields0[1].Descriptor()
	// workflowsteptemplate.NameValidator is a validator for the "name" field. It is called by the builders before save.
	workflowsteptemplate.NameValidator = workflowsteptemplateDescName.Validators[0].(func(string) error)
	// workflowsteptemplateDescLabels is the schema descriptor for labels field.
	workflowsteptemplateDescLabels := workflowsteptemplateMixinFields0[3].Descriptor()
	// workflowsteptemplate.DefaultLabels holds the default value on creation for the labels field.
	workflowsteptemplate.DefaultLabels = workflowsteptemplateDescLabels.Default.(map[string]string)
	// workflowsteptemplateDescAnnotations is the schema descriptor for annotations field.
	workflowsteptemplateDescAnnotations := workflowsteptemplateMixinFields0[4].Descriptor()
	// workflowsteptemplate.DefaultAnnotations holds the default value on creation for the annotations field.
	workflowsteptemplate.DefaultAnnotations = workflowsteptemplateDescAnnotations.Default.(map[string]string)
	// workflowsteptemplateDescCreateTime is the schema descriptor for create_time field.
	workflowsteptemplateDescCreateTime := workflowsteptemplateMixinFields0[5].Descriptor()
	// workflowsteptemplate.DefaultCreateTime holds the default value on creation for the create_time field.
	workflowsteptemplate.DefaultCreateTime = workflowsteptemplateDescCreateTime.Default.(func() time.Time)
	// workflowsteptemplateDescUpdateTime is the schema descriptor for update_time field.
	workflowsteptemplateDescUpdateTime := workflowsteptemplateMixinFields0[6].Descriptor()
	// workflowsteptemplate.DefaultUpdateTime holds the default value on creation for the update_time field.
	workflowsteptemplate.DefaultUpdateTime = workflowsteptemplateDescUpdateTime.Default.(func() time.Time)
	// workflowsteptemplate.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	workflowsteptemplate.UpdateDefaultUpdateTime = workflowsteptemplateDescUpdateTime.UpdateDefault.(func() time.Time)
	// workflowsteptemplateDescType is the schema descriptor for type field.
	workflowsteptemplateDescType := workflowsteptemplateFields[0].Descriptor()
	// workflowsteptemplate.TypeValidator is a validator for the "type" field. It is called by the builders before save.
	workflowsteptemplate.TypeValidator = workflowsteptemplateDescType.Validators[0].(func(string) error)
	// workflowsteptemplateDescSchema is the schema descriptor for schema field.
	workflowsteptemplateDescSchema := workflowsteptemplateFields[1].Descriptor()
	// workflowsteptemplate.DefaultSchema holds the default value on creation for the schema field.
	workflowsteptemplate.DefaultSchema = workflowsteptemplateDescSchema.Default.(property.Schemas)
}
