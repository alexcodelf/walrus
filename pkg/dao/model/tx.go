...
func (tx *Tx) init() {
	...
	tx.WorkflowStepTemplate = NewWorkflowStepTemplateClient(tx.config)
}
...
func (tx *Tx) WorkflowStepTemplates() *WorkflowStepTemplateClient {
	return tx.WorkflowStepTemplate
}
...
func (tx *Tx) Intercept(interceptors ...Interceptor) {
	...
	tx.WorkflowStepTemplate.Intercept(interceptors...)
}
...
func (tx *Tx) Use(hooks ...Hook) {
	...
	tx.WorkflowStepTemplate.Use(hooks...)
}
