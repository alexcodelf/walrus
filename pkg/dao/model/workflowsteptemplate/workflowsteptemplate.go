...
const (
	// Label holds the string label denoting the workflowsteptemplate type in the database.
	Label = "workflow_step_template"
	...
	FieldSchema = "schema"
	// Table holds the table name of the workflowsteptemplate in the database.
	Table = "workflow_step_templates"
)

// Columns holds all SQL columns for workflowsteptemplate fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
var (
	...
	DefaultSchema property.Schemas
)

// OrderOption defines the ordering options for the WorkflowStepTemplate queries.
