...
type ClientSet interface {
	...
	// WorkflowStepTemplates returns the client for interacting with the WorkflowStepTemplate builders.
	WorkflowStepTemplates() *WorkflowStepTemplateClient
...
// WorkflowStepTemplateClientGetter is an interface that allows getting WorkflowStepTemplateClient.
type WorkflowStepTemplateClientGetter interface {
	// WorkflowStepTemplates returns the client for interacting with the WorkflowStepTemplate builders.
	WorkflowStepTemplates() *WorkflowStepTemplateClient
}
