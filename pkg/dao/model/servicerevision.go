...
func (*ServiceRevision) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case servicerevision.FieldID, servicerevision.FieldProjectID, servicerevision.FieldEnvironmentID, servicerevision.FieldServiceID, servicerevision.FieldWorkflowStepExecutionID:
