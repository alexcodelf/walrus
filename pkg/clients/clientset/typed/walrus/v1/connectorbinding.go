...
type ConnectorBindingInterface interface {
	...
	Apply(ctx context.Context, connectorBinding *walrusv1.ConnectorBindingApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ConnectorBinding, err error)
...
func newConnectorBindings(c *WalrusV1Client, namespace string) *connectorBindings {
...
func (c *connectorBindings) Apply(ctx context.Context, connectorBinding *walrusv1.ConnectorBindingApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ConnectorBinding, err error) {
