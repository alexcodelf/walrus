...
const (
	NameWorkflow = "walrus-workflow"
)

const (
	//nolint:lll
	defaultWorkflowChartURL = "https://github.com/argoproj/argo-helm/releases/download/argo-workflows-0.36.1/argo-workflows-0.36.1.tgz"
